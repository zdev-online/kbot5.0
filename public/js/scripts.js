...
(function (global){
const axios = module.exports.axios = require('axios').default;

global.axios = axios;

window.onload = async () => {
    let spinner_loading = document.getElementById('loading-page');
    spinner_loading.style.display = 'flex';
    try{
        let HOME_PAGE       = await axios.post('/');    
    } catch(error) {
